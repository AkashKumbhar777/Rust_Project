...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(web::resource("/trycart/{uid}").route(web::post().to(controller::trycart_handler::create_trycart)))//TryCart Handlers
            .service(web::resource("/getAlltrycarts").route(web::get().to(controller::trycart_handler::get_all_trycarts)))
            ...
            .service(web::resource("/buycart/{uid}").route(web::post().to(controller::buycart_handler::create_buycart)))//BuyCart Handlers
            .service(web::resource("/buycarts").route(web::get().to(controller::buycart_handler::get_all_buycarts)))
            .service(web::resource("/buycarts/{uid}").route(web::get().to(controller::buycart_handler::get_buycart_by_user_id)))
